...
public class AuctionHouseTest {
    ...
    @Test
    public void testNotRegisteredSellerAddLot() {
        logger.info(makeBanner("testNotRegisteredSellerAddLot"));
        runStory(1);
        assertError(house.addLot("SellerQ", 2, "Painting", new Money("200.00")));       
    }
    ...
    @Test
    public void testNoteInterestByNotRegisteredBuyer() {
        logger.info(makeBanner("testNoteInterestByNotRegisteredBuyer"));
        runStory(3);
    ...
    @Test
    public void testOpenAuctionOfNotRegisteredLot() {
        logger.info(makeBanner("testOpenAuctionOfNotRegisteredLot"));
        runStory(5);    
    ...
    @Test
    public void testMakeBidButNoInterest() {
    	    logger.info(makeBanner("testMakeBidButNoInterest"));
    	    runStory(7);
    	    assertError(house.makeBid("BuyerB", 7, new Money("3000")));
    }
    
    @Test
    public void testBidLessThanReserve() {
        logger.info(makeBanner("testBidLessThanReserve"));
        runStory(7);
        assertError(house.makeBid("BuyerB", 1, new Money("5")));
    }
    ...
    @Test
    public void testCloseAuctionWithHammerLessThanReserve() {
        logger.info(makeBanner("testCloseAuctionWithHammerLessThanReserve"));
        runStory(8);
        assertError(house.closeAuction("Auctioneer1",  1));
    }
    
    @Test
    public void testCloseAuctionWithNotRegisteredLot() {
        logger.info(makeBanner("testCloseAuctionWithNotRegisteredLot"));
        runStory(8);
        assertError(house.closeAuction("Auctioneer1",  1));
    }
    
    @Test
    public void testCloseAuctionWithNotOpenedLot() {
        logger.info(makeBanner("testCloseAuctionWithNotOpenedLot"));
        runStory(8);
        assertError(house.closeAuction("Auctioneer1",  1));
    ...
    public void testCloseAuctionWithDifferentAuctioneer() {
        logger.info(makeBanner("testCloseAuctionWithDifferentAuctioneer"));
        runStory(8);
        assertError(house.closeAuction("Auctioneer1",  1));
